...
console.BACKGROUND_COLOR = {1, 1, 1, 0.1}
console.TEXT_COLOR = {0, 0, 0, 1}
console.COMPLETION_TEXT_COLOR = {0.3, 0.2, 0.8, 1}
console.ERROR_COLOR = {1, 0, 0, 1}

console.CURSOR_RADIUS = 3
console.CURSOR_STYLE = "fill"
...
console.HELP_TEXT = [[Evaluate statements. Use `commands` for more.]]


-- Builtin commands.
console.COMMANDS = {
  clear = function() console.clear() end,
  quit, exit = function() love.event.quit(0) end,
  help = function() print(console.HELP_TEXT) end,
  commands = function() list_commands() end,
}

function change_bg_color(r,g,b)

end

-- custom commands
custom = {
  bordertoggle = function() if bg.enabled == true then
    bg.enabled = false elseif
    bg.enabled == false then
      bg.enabled = true
      end
    end,
    --- don't know how to pass functions
    ...
    textcolor = function(r,g,b)
      console.TEXT_COLOR[1] = r
      console.TEXT_COLOR[2] = g
      console.TEXT_COLOR[3] = b
    end,
    vapor = function() love.filesystem.load("/lib/vapor/vapor.lua")() end,
    loadtest = function() love.filesystem.load("test.lua")() end,
}

-- helptext for custom commands
custom_helptext = {
  bgcolor = "change background color",
  textcolor = "change text color",
  bordertoggle = "Toggle the window border",
  vapor = "Run a vapor interpreter",
  loadtest = "Load a lua file that prints a string"
}
    
TableConcat(console.COMMANDS, custom)
...
TableConcat(console.COMMAND_HELP, custom_helptext)
...
function console.draw()
  ...
  love.graphics.setColor(unpack(console.TEXT_COLOR))
  ...
  function draw_cursor()
    ...
    love.graphics.rectangle(console.CURSOR_STYLE,
      cursorx,
      love.graphics.getHeight() - console.VERTICAL_MARGIN - console.FONT:getHeight(),
      console.FONT:getWidth(0),
      console.FONT:getHeight(0), console.CURSOR_RADIUS, console.CURSOR_RADIUS)
  end
...
function console.textinput(input)
  ...
  if input == console.TOGGLE then
    enabled = not enabled
    console.clear() -- clears lurker init message
    return
  end
